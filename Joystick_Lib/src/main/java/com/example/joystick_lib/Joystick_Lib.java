...
public class Joystick_Lib extends View implements Runnable{
    ...
    */
     ...
     */
    private static final int DEFAULT_WIDTH_BORDER = 5;
     ...
     */
    public Joystick_Lib(Context context) {
        this(context, null);
    }


    public Joystick_Lib(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
     ...
     */
    public Joystick_Lib(Context context, AttributeSet attrs) {
        super(context, attrs);
